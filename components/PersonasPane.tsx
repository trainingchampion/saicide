...
const PERSONA_CAPABILITIES: Record<string, string[]> = {
    'General Developer': ['Code Generation', 'Explanations', 'Refactoring'],
    'Senior Cloud Architect': ['System Design', 'Terraform', 'Cost Analysis'],
    'Security & Compliance Auditor': ['Vulnerability Scan', 'Compliance', 'Security Best Practices'],
    'UI/UX Polish Expert': ['Tailwind CSS', 'Aesthetics', 'Accessibility'],
    'Debugging Specialist': ['Stack Traces', 'Logic Flaws', 'Error Analysis'],
    'Documentation Guru': ['README Generation', 'API Docs', 'Technical Specs'],
};
    ...
    <div className="p-2 h-full flex flex-col bg-[var(--color-background-secondary)] text-[var(--color-text-primary)]">
      <div className="flex justify-between items-center p-3 flex-shrink-0 border-b border-[var(--color-border)] mb-4">
        <div className="flex items-center gap-2">
            <h2 className="text-xs font-black uppercase text-[var(--color-text-secondary)] tracking-[0.2em]">Neural Personas</h2>
        </div>
