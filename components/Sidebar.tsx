...
const SIDEBAR_GROUPS = [
    {
        ...
        items: [
            ...
            { id: Panel.SOURCE_CONTROL, icon: <GitBranch size={20} />, label: "Source Control", minPlan: 'Pro' },
        ]
    },
    {
        label: "Engineering",
    ...
    },
    {
        ...
        items: [
            ...
            { id: Panel.DOCKER, icon: <Container size={20} />, label: "Container Studio", minPlan: 'Hobby' },
            { id: Panel.SECURITY, icon: <ShieldCheck size={20} />, label: "Security & Governance", minPlan: 'Hobby' },
    ...
    },
    {
        ...
        items: [
            ...
            { id: Panel.KANBAN, icon: <KanbanBoardIcon size={20} />, label: "Tasks", minPlan: 'Hobby' },
