  ...
  return (
    <div className="p-2 h-full flex flex-col bg-[#1c1c1e]">
        <div className="flex justify-between items-center p-3 flex-shrink-0 border-b border-white/5 mb-4">
            <div>
                <h2 className="text-xs font-black uppercase text-gray-500 tracking-[0.2em]">Neural Registry</h2>
                <p className="text-[9px] text-gray-600 font-bold uppercase mt-0.5">Workspace Intelligence</p>
            </div>
