...
const FileExplorer: React.FC<FileExplorerProps> = ({ rootNode, onFileSelect, onNewFile, onNewFolder, onRefresh, onSaveToGithub, onBuild, onRenameFile, onStartRenaming, onDeleteFile, onMoveNode, collaborationState = {}, teamMembers = [], activeFile, onCollapse, securityIssues = [], onOpenDocuments, onPanelChange, onOpenInTerminal }) => {
